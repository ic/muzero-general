...
class MuZeroConfig:
    def __init__(self):
        ...
        self.batch_size = (
            32  # Number of parts of games to train on at each training step
        )
        ...
        self.replay_buffer_size = (
            5000  # Number of self-play games to keep in the replay buffer
        )
        self.num_unroll_steps = (
            7  # Number of game moves to keep for every batch element
        )
