...
class MuZeroConfig:
    def __init__(self):
        ...
        self.action_space = list(
            range(self.game.policy_tensor_shape()[0])
        ...
        self.replay_buffer_size = (
            3000  # Number of self-play games to keep in the replay buffer
        )
        self.num_unroll_steps = (
            20  # Number of game moves to keep for every batch element
        )
