...
class MuZeroConfig:
    def __init__(self):
        ...
        self.checkpoint_interval = (
            50  # Number of training steps before using the model for self-playing
        )
        ...
        self.replay_buffer_size = (
            10000  # Number of self-play games to keep in the replay buffer
        )
        self.num_unroll_steps = (
            121  # Number of game moves to keep for every batch element
        )
